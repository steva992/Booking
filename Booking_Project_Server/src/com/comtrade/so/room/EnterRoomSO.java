...
public class EnterRoomSO extends GeneralSystemOperation<GenericList<GeneralDomain>> {

	@Override
	protected void runConcreteSO(GenericList<GeneralDomain> object) throws SQLException, Exception {
		GenericList<GeneralDomain>list1=object;
		Property property=(Property) object.get(0);
		Room room=(Room) object.get(1);
		Room_Info room_info=(Room_Info) object.get(2);
		Cache.getInstance().addInMap(property.getName(),room);
		Cache.getInstance().addInMap(property.getName(),room_info);
