...
public class Login extends JPanel {
	...
	public Login() {
		...
		CommonMethod.setNewPicutreOnButton(AbsolutePath.absolutePath()+PicturesURL.PICTURE_FOR_LOGIN_BUTTON_LOGIN.getValue(), btnLogin);
		add(btnLogin);
		...
		CommonMethod.setNewPicutreOnButton(AbsolutePath.absolutePath()+PicturesURL.PICTURE_FOR_LOGIN_BUTTON_SIGN_UP.getValue(), btnSignup);
		add(btnSignup);
		...
		add(lblWallpaper);
		CommonMethod.setNewPicutreOnLabel(AbsolutePath.absolutePath()+PicturesURL.PICTURE_FOR_LOGIN_BACKGROUND.getValue(),lblWallpaper);
